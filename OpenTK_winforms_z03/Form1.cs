...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private bool statusCubeTex6;
        private bool statusCubeTex7;
        ...
        //for rectangle
        private int[] arrRectanglesList = new int[100];    //Lista de vertexuri pentru construirea cubului prin intermediul triunghiurilor. Ne bazăm pe lista de vertexuri.
        private int nRectanglesList;
        ...
        private void SetupValues() {
            ...
            statusCubeTex6 = false;
            statusCubeTex7 = false;
            dirt = true;
            brick = true;
            colorTex = 0;
        }
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            {
                DrawTriangleWithTex5();
            }
            if (statusCubeTex6 == true)
            {
                DrawRectangleWithTex6();
            }
            if (statusCubeTex7 == true)
            {
                DrawCircleWithTex7();
            }
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[0], "dirtTexture.jpg");
            LoadTexture(textures[1], "far_cry2Texture.jpg");
        }
        ...
        private void btnTexT_5_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            loadVertex();
            loadTList();
        ...
        private void btnTexQ_3_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            loadVertex();
            loadQList();
        ...
        private void btnTexQ_4_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            loadVertex();
            loadQList();
        ...
        private void btnTexQ_5_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            loadVertex();
            loadQList();
        ...
        //Deseneaza triunghiul cu textura 2
        ...
        private void btnTexT_6_Click(object sender, EventArgs e)
        {
            statusCubeTex6 = true;
            GlControl1.Invalidate();
        }

        private void btnTexT_5_Click_1(object sender, EventArgs e)
        {
            statusCubeTex5 = true;
            GlControl1.Invalidate();
        }
        ...
        //deseneaza triunghi
        private void DrawTriangleWithTex5()
        {
            if (dirt == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            GL.Begin(PrimitiveType.Triangles);
            for (int i = 0; i < nTrianglesList; i = i + 3)
            {
                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(arrVertex[arrTrianglesList[i], 0], arrVertex[arrTrianglesList[i], 1], arrVertex[arrTrianglesList[i], 2]);
        ...
        private void DrawRectangleWithTex6()
        {
            if (dirt == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            GL.Begin(PrimitiveType.Quads);
            for (int i = 0; i < nRectanglesList; i = i + 4)
            {
                GL.TexCoord2(0.0, 0.0);
                GL.Vertex3(arrVertex[arrRectanglesList[i], 0], arrVertex[arrRectanglesList[i], 1], arrVertex[arrRectanglesList[i], 2]);

                GL.TexCoord2(1.0, 0.0);
                GL.Vertex3(arrVertex[arrRectanglesList[i + 1], 0], arrVertex[arrRectanglesList[i + 1], 1], arrVertex[arrRectanglesList[i + 1], 2]);

                GL.TexCoord2(1.0, 1.0);
                GL.Vertex3(arrVertex[arrRectanglesList[i + 2], 0], arrVertex[arrRectanglesList[i + 2], 1], arrVertex[arrRectanglesList[i + 2], 2]);

                GL.TexCoord2(0.0, 1.0);
                GL.Vertex3(arrVertex[arrRectanglesList[i + 3], 0], arrVertex[arrRectanglesList[i + 3], 1], arrVertex[arrRectanglesList[i + 3], 2]);
            }
            GL.End();
        }

        private void DrawCircleWithTex7()
        {
            if (dirt == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            for (int i = 0; i <= segments; i++)
            {
                ...
                // Texture coordinates
                GL.TexCoord2(0.5 + 0.5 * x, 0.5 + 0.5 * y);
